...
- Deploy only `var/config-site`; catalog source databases, `.env` files, and verification artifacts stay private. Pushes and preview tags publish the page without touching the hosted catalog.
